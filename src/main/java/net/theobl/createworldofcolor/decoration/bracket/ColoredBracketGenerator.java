package net.theobl.createworldofcolor.decoration.bracket;
...
public class ColoredBracketGenerator extends DirectionalAxisBlockStateGen {

    private final String material;

    public ColoredBracketGenerator(String material) {
    ...
    public <T extends Block> ModelFile getModel(DataGenContext<Block, T> ctx, RegistrateBlockstateProvider prov,
        ...
        return prov.models()
                .withExistingParent(path + "_" + material, Create.asResource(path))
    ...
    public static <I extends BlockItem, P> NonNullFunction<ItemBuilder<I, P>, P> itemModel(String material) {
        return b -> b.model((c, p) ->
                        p.withExistingParent(c.getName(), Create.asResource("block/bracket/item"))
